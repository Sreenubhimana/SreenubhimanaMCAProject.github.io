...
<div class="main">
  ...
  <tr>
    <td width="195" bgcolor="#FF0000"><div align="center" class="style1">Collusion  Attacks</div></td>
    <td width="195" bgcolor="#FF0000"><div align="center" class="style1">Sybil  Attacks</div></td>
  </tr>
...
<%
	...
	String query1="select count(*) from Attackers2 where cname='"+cname+"' "; 
...
if ( rs1.next() )
{
  ...
  <tr>
    ...
    <td><div align="center" class="style2"><%=j%></div></td>
  </tr>
