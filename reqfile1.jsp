      	...
      	try 
	{
           ...
           SimpleDateFormat sdfDate = new SimpleDateFormat(
			...
			if(rs2.next())
			{
			  ...
			  <tr>
			    <td width="150" bgcolor="#FF0000"><span class="style4">Cloud Name </span></td>
			    <td width="355"><%= cname %></td>
			  </tr>
			  <tr>
			    <td bgcolor="#FF0000"><span class="style4">Owner Name </span></td>
			    <td><%= oname %></td>
			  </tr>
			  <tr>
			    <td bgcolor="#FF0000"><span class="style4">File Name </span></td>
			    <td><input type="text" name="t4" id="t4" value="<%= fname %>" readonly /></td>
			  </tr>
			  <tr>
			    <td bgcolor="#FF0000"><span class="style4">File Content </span></td>
		  ...
		  <tr>
		    <td width="106" bgcolor="#FF0000"><span class="style2">Cloud Name </span></td>
		    <td width="325"><%= cname %></td>
		  </tr>
		  <tr>
		    <td bgcolor="#FF0000"><span class="style2">Owner Name </span></td>
		    <td><%= oname %></td>
		  </tr>
		  <tr>
		    <td bgcolor="#FF0000"><span class="style2">File Name </span></td>
		    <td><input type="text" name="t4" id="t4" value="<%= fname %>" readonly /></td>
		  </tr>
		  <tr>
		    <td bgcolor="#FF0000"><span class="style2">File Content </span></td>
		    <td><textarea name="textarea" id="textarea" cols="50" rows="15"><%= s2 %></textarea></td>
		  </tr>
		  <tr>
		    <td>&nbsp;</td>
