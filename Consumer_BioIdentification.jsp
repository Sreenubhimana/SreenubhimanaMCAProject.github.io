...
<head>
<title>Consumer_BioIdentification</title>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="mainbar">
            <div class="article">
            <p>&nbsp;</p>
              <form action="CBioIdentiry.jsp" method="post" id="sendemail" enctype="multipart/form-data">
            <ol><li><ol><ol><ol>
              <p><span class="style36">
                <label for="label"><span class="style6">Consumer Biometric Authentication<br />
                <br />
