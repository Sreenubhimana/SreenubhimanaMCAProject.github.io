...
<div class="main">
  ...
  <div class="content">
    ...
    <tr>
      <td bgcolor="#FF0000"><span class="style1">Enter the File Name </span></td>
      <td><input type="text" name="t2" /></td>
    </tr>
    <tr>
      <td bgcolor="#FF0000"><span class="style1">Enter the Owner Name </span></td>
      <td><input type="text" name="t3" /></td>
    </tr>
	 <tr>
      <td bgcolor="#FF0000"><span class="style1">Enter the SK </span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><label>
        <input type="submit" name="Decrypt" value="Submit">
      </label></td>
    </tr>
  </table>
              </form>
