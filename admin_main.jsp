      ...
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <div class="clr">
            <div align="center">
              <p>&nbsp;</p>
              <p><img src="images/handshake.jpg" width="197" height="130" /></p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
            </div>
          </div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="View_TD_Results.jsp">View Time Delay Results</a></li>
			<li><a href="View_TPT_Results.jsp">View Throughput Results</a></li>
