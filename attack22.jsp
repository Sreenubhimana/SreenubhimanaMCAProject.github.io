...
<%
  ...
  <table width="548" border="1" align="center">
    <tr>
      <td bgcolor="#FF0000"><span class="style1 style10"><strong> Cloud Name:- </strong></span></td>
      <td><input type="text" name="t1" value="<%= cname %>"  readonly></td>
    </tr>
    <tr>
      <td bgcolor="#FF0000"><span class="style1 style10"><strong> File Name:- </strong></span></td>
      <td><input type="text" name="t2" value="<%= fname %>" readonly></td>
    </tr>
     <tr>
      <td bgcolor="#FF0000"><span class="style1 style10"><strong> Owner Name:- </strong></span></td>
      <td><input type="text" name="t3" value="<%= oname %>" readonly></td>
    </tr>
    <tr>
      <td bgcolor="#FF0000"><span class="style1 style10"><strong>Change the File Content:-</strong></span></td>
